...
def role_art_text(role_name):
    """Generate role title art using pyfiglet dos_rebel font."""
    if pyfiglet is None:
        return role_name.upper()
    try:
        return blueText(pyfiglet.figlet_format(role_name, font="dos_rebel").rstrip("\n"))
    except Exception:
        return role_name.upper()
...
gewonnen_ascii_art = pyfiglet.figlet_format("Gewonnen", font="dos_rebel").rstrip("\n") if pyfiglet else "Gewonnen"
logo = pyfiglet.figlet_format("Werwolf", font="dos_rebel").rstrip("\n") if pyfiglet else "Werwolf"
